...
extern "C"  void Graphics_Blit_m2695454291 (Il2CppObject * __this /* static, unused */, Texture_t2526458961 * ___source0, RenderTexture_t1963041563 * ___dest1, Material_t3870600107 * ___mat2, const MethodInfo* method)
{
	int32_t V_0 = 0;
	{
		V_0 = (-1);
...
extern Il2CppClass* Object_t3071478659_il2cpp_TypeInfo_var;
extern const uint32_t Graphics_SetRenderTargetImpl_m527058684_MetadataUsageId;
extern "C"  void Graphics_SetRenderTargetImpl_m527058684 (Il2CppObject * __this /* static, unused */, RenderTexture_t1963041563 * ___rt0, int32_t ___mipLevel1, int32_t ___face2, int32_t ___depthSlice3, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
		il2cpp_codegen_initialize_method (Graphics_SetRenderTargetImpl_m527058684_MetadataUsageId);
		s_Il2CppMethodIntialized = true;
	}
	{
		RenderTexture_t1963041563 * L_0 = ___rt0;
		IL2CPP_RUNTIME_CLASS_INIT(Object_t3071478659_il2cpp_TypeInfo_var);
	...
	{
		RenderTexture_t1963041563 * L_2 = ___rt0;
		NullCheck(L_2);
		RenderBuffer_t3529837690  L_3 = RenderTexture_get_colorBuffer_m1260375694(L_2, /*hidden argument*/NULL);
		RenderTexture_t1963041563 * L_4 = ___rt0;
		NullCheck(L_4);
		RenderBuffer_t3529837690  L_5 = RenderTexture_get_depthBuffer_m990382574(L_4, /*hidden argument*/NULL);
		int32_t L_6 = ___mipLevel1;
		int32_t L_7 = ___face2;
		int32_t L_8 = ___depthSlice3;
		Graphics_SetRenderTargetImpl_m3786045502(NULL /*static, unused*/, L_3, L_5, L_6, L_7, L_8, /*hidden argument*/NULL);
		goto IL_0029;
	}
...
extern "C"  void Graphics_SetRenderTarget_m3051614107 (Il2CppObject * __this /* static, unused */, RenderTexture_t1963041563 * ___rt0, const MethodInfo* method)
{
	{
		RenderTexture_t1963041563 * L_0 = ___rt0;
		Graphics_SetRenderTargetImpl_m527058684(NULL /*static, unused*/, L_0, 0, (-1), 0, /*hidden argument*/NULL);
		return;
	}
}
